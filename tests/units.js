...
J.setMeal('dinner');
t('표시: 체인점 이름 대신 종류(일품양평해장국 → 해장국)',!/일품/.test(J.catText(P('일품양평해장국 제주도청점','음식점 > 한식 > 해장국 > 일품양평해장국'))),J.catText(P('일품양평해장국 제주도청점','음식점 > 한식 > 해장국 > 일품양평해장국')));
t('표시: "국밥·국수 · 한식" 대신 "국밥"',J.catText(P('맛장터해장국','음식점 > 한식'))==='국밥',J.catText(P('맛장터해장국','음식점 > 한식')));
t('표시: 횟집은 "횟집 · 회" 대신 "횟집"',J.catText(P('만년호횟집','음식점 > 한식 > 해물,생선 > 회'))==='횟집',J.catText(P('만년호횟집','음식점 > 한식 > 해물,생선 > 회')));
t('표시: 이름에 "회"가 있어도 분류 유지(회찬숙성회)',J.catText(P('회찬숙성회','음식점 > 한식 > 해물,생선 > 회'))==='횟집',J.catText(P('회찬숙성회','음식점 > 한식 > 해물,생선 > 회')));
t('표시: 복어잡는집은 "복어" 유지',/복어/.test(J.catText(P('복어잡는집','음식점 > 한식 > 해물,생선 > 복어'))),J.catText(P('복어잡는집','음식점 > 한식 > 해물,생선 > 복어')));
t('표시: 보배반점(체인) → 중국요리',/중국요리/.test(J.catText(P('보배반점 제주도청점','음식점 > 중식 > 중국요리 > 보배반점')))&&!/보배/.test(J.catText(P('보배반점 제주도청점','음식점 > 중식 > 중국요리 > 보배반점'))));
t('표시: 돈까스집은 일식·회가 아니라 일식',J.foodLabelOf(P('몽땅하우스','음식점 > 일식 > 돈까스,우동'))==='일식',J.foodLabelOf(P('몽땅하우스','음식점 > 일식 > 돈까스,우동')));
t('표시: 일식만 있는 곳 → 일식',J.foodLabelOf(P('몽땅하우스','음식점 > 일식'))==='일식',J.foodLabelOf(P('몽땅하우스','음식점 > 일식')));
t('표시: 동네 횟집 → 횟집',J.foodLabelOf(P('바다횟집','음식점 > 한식 > 해물,생선 > 회'))==='횟집',J.foodLabelOf(P('바다횟집','음식점 > 한식 > 해물,생선 > 회')));
t('표시: 칼국수집 → 국수',J.foodLabelOf(P('제주칼국수','음식점 > 한식 > 국수 > 칼국수'))==='국수',J.foodLabelOf(P('제주칼국수','음식점 > 한식 > 국수 > 칼국수')));
t('표시: 제과점 → 베이커리',J.foodLabelOf(P('빵집','음식점 > 간식 > 제과,베이커리'))==='베이커리');
t('저녁 표시: 소머리국밥 → 국밥',J.foodLabelOf(P('연동한우소머리국밥','음식점 > 한식 > 국밥'))==='국밥',J.foodLabelOf(P('연동한우소머리국밥','음식점 > 한식 > 국밥')));
J.setMeal('lunch');
